...
def Core(data):
    ...
    adb_grid_param = {  'learning_rate': [0.001, 0.01, 0.1, 1],
                        ...
                        'n_estimators': list(range(50, 150,20)),
                  }
    ...
    ###
    lgb_grid_param = { 'n_estimators' : list(range(50,800,50)),
                  'learning_rate' : float_range(0.01,0.15,0.01),
                  'max_depth' : list(range(1,20,2)),
                  'num_leaves' : list(range(2,10,2))
                  }
    ...
    ###
    rfr_grid_param = { 'n_estimators' : list(range(50,800,50)),
    ...
    ###
    xgb_grid_param = { 'n_estimators' : list(range(50,800,50)),
    ...
    lasso_grid_param = { 'alpha': float_range(0.1, 1.0, 0.1),
                        'max_iter': list(range(100, 10001, 1000))
                  }
    ...
    ###
    gbr_grid_param = { 'n_estimators': list(range(50, 800, 50)),
                        'learning_rate': float_range(0.01, 0.15, 0.02),
    ...
    ###
    br_grid_param = { 'n_estimators': list(range(50, 800, 50)),
...
for filename in os.listdir(dataset_folder):
    if filename.endswith(".csv"):
        ...
        data = pd.read_csv(dataset_path, encoding='gb2312')  # 读取数据集为 DataFrame
